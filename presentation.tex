...
\begin{frame}[fragile]{Compressed Multipole Expansion}
 ...
 For 2D Helmholtz equation we also have,
 \[
...
Multipole expansion coefficients go from $\mathcal{O}(p^d)$ to $\mathcal{O}(p^{d-1})$.
...
Note that the coefficients are derivative terms and using the PDE, we can find
linear combinations for the coefficients.
...
\draw[->] (0,-0.2) to [bend right=45] node[right] {} (0.5,-0.2);
\draw[->] (0,-0.2) to [bend right=45] node[right] {} (1,-0.2);
\draw[->] (0,-0.2) to [bend right=45] node[right] {} (1.5,-0.2);
\draw[->] (0,-0.2) to [bend right=45] node[right] {} (2,-0.2);
\draw[->] (0,-0.2) to [bend right=45] node[right] {} (2.5,-0.2);
\draw[->] (0,-0.2) to [bend right=45] node[right] {} (3,-0.2);
\draw[->] (0,-0.2) to [bend right=45] node[right] {} (3.5,-0.2);
\draw[->] (0,-0.2) to [bend right=45] node[right] {} (4,-0.2);
\draw[->] (0.5,-0.2) to [bend right=45] node[right] {} (1,-0.2);
\draw[->] (0.5,-0.2) to [bend right=45] node[right] {} (1.5,-0.2);
\draw[->] (0.5,-0.2) to [bend right=45] node[right] {} (2,-0.2);
\draw[->] (0.5,-0.2) to [bend right=45] node[right] {} (2.5,-0.2);
\draw[->] (0.5,-0.2) to [bend right=45] node[right] {} (3,-0.2);
\draw[->] (0.5,-0.2) to [bend right=45] node[right] {} (3.5,-0.2);
\draw[->] (0.5,-0.2) to [bend right=45] node[right] {} (4,-0.2);

\draw[->] (0,0.3) to [bend right=45] node[right] {} (0.5,0.3);
\draw[->] (0,0.3) to [bend right=45] node[right] {} (1.0,0.3);
\draw[->] (0,0.3) to [bend right=45] node[right] {} (1.5,0.3);
\draw[->] (0,0.3) to [bend right=45] node[right] {} (2.0,0.3);
\draw[->] (0,0.3) to [bend right=45] node[right] {} (2.5,0.3);
\draw[->] (0,0.3) to [bend right=45] node[right] {} (3.0,0.3);
\draw[->] (0,0.3) to [bend right=45] node[right] {} (3.5,0.3);
...
\foreach \Point in { (10, 0), (10.5, 0), (11.0, 0), (11.5, 0), (12.0, 0), (12.5, 0), (13.0, 0), (13.5, 0), (14.0, 0), (10.5, 0), (10, 0.5), (10.5, 0.5), (11.0, 0.5), (11.5, 0.5), (12.0, 0.5), (12.5, 0.5), (13.0, 0.5), (13.5, 0.5)}{
    \draw \Point node[anchor=center,fill=blue,circle,scale=0.5] {};
}

\foreach \Point in { (10.0, 1.0), (10.0, 1.5), (10.0, 2.0), (10.0, 2.5), (10.0, 3.0), (10.0, 3.5), (10.0, 4.0), (10.5, 1.0), (10.5, 1.5), (10.5, 2.0), (10.5, 2.5), (10.5, 3.0), (10.5, 3.5), (11.0, 1.0), (11.0, 1.5), (11.0, 2.0), (11.0, 2.5), (11.0, 3.0), (11.5, 1.0), (11.5, 1.5), (11.5, 2.0), (11.5, 2.5), (12.0, 1.0), (12.0, 1.5), (12.0, 2.0), (12.5, 1.0), (12.5, 1.5), (13.0, 1.0) }{
    \draw \Point node[anchor=center,fill=blue,circle,scale=0.5] {};
}
